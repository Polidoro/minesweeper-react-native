    ...
    return (
      <View style={styles.gamePage.mainContainer}>
        ...
        <View style={styles.gamePage.flagInfo}>
          <Text style={styles.gamePage.flagInstructions}><Text style={{fontWeight: 'bold'}}>Long-press</Text> to place a flag, Or <Text style={{fontWeight: 'bold'}}>drag and drop</Text> this icon</Text>
